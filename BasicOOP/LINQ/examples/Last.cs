...
namespace LINQ.examples
{
    public class Last
    {
        public T GetLastElement<T>(IEnumerable<T> elements, Func<T, bool>? predicate)
        {
                                       ...
                                       // si es struct, enum o cualquier valor parecido devuelve true
            {
                ...
                return predicate is not null ? elements.LastOrDefault(predicate) : elements.LastOrDefault();
            }
            else
            {
